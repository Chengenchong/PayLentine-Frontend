            ...
            {withdrawStep === 0 && (
              <>
                <RadioGroup
                  ...
                  onChange={(e) =>
                    setWithdrawForm({ ...withdrawForm, type: e.target.value })
                  }
                >
                  <FormControlLabel
                    value="ewallet"
                    control={<Radio />}
                    label="Withdraw to E-Wallet"
                  />
                  <FormControlLabel
                    value="bank"
                    control={<Radio />}
                  ...
                  <FormControlLabel
                    value="currency"
                    control={<Radio />}
                    label="Withdraw to Other Currency Balance"
                  />
                </RadioGroup>
                <TextField
                  label="Amount"
                  ...
                  InputProps={{ startAdornment: selectedCurrency.code }}
                />
                {(withdrawForm.type === 'ewallet' ||
                  withdrawForm.type === 'bank') && (
                  <TextField
                    label={
                      withdrawForm.type === 'ewallet'
                        ? 'E-Wallet Account'
                ...
                >
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    >
                      ...
                      <Typography variant="body2">via PayLentine</Typography>
                    </Box>
                  </Box>
                  {/* Recipient details */}
                  <Box sx={{ mb: 2 }}>
