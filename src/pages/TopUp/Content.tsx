...
const TopUpContent = () => {
  ...
  const [step, setStep] = useState<'method' | 'qr' | 'pin' | 'success'>(
    'method'
  );
          ...
          >
            ...
            <Box
              sx={{
                ...
                borderRadius: 2,
                mb: 2,
                background: expandBank ? '#f8f7fc' : '#fff',
                transition: 'background 0.2s',
                width: '100%',
              }}
            >
              ...
              {expandBank && (
                <Box sx={{ px: 2, pb: 2, pt: 1 }}>
                  ...
                  <Typography
                    sx={{ fontWeight: 600, color: brandColor, mb: 1 }}
                  >
                    Amount
                  </Typography>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                    ...
                    <TextField
                      ...
                      inputProps={{
                        style: { fontSize: 22, fontWeight: 700, width: 120 },
                      }}
                  ...
                  >
                    {quickAmounts.map((amt) => (
                      <Button
                        key={amt}
                        variant="outlined"
                        sx={{ borderRadius: 2, minWidth: 80, fontWeight: 700 }}
                  ...
                  <Button
                    ...
                    disabled={
                      !selectedBank || !bankAmount || Number(bankAmount) <= 0
                    }
                    onClick={() => {
                      setSummary({
                        method: 'Online Banking',
            ...
            <Box
              sx={{
                ...
                borderRadius: 2,
                mb: 2,
                background: expandEwallet ? '#f8f7fc' : '#fff',
                transition: 'background 0.2s',
                width: '100%',
              }}
            >
                    ...
                    <TextField
                      ...
                      onChange={(e) => {
                        if (
                          ...
                          setEwalletAmount(e.target.value);
                      }}
                      inputProps={{
                        style: { fontSize: 22, fontWeight: 700, width: 120 },
                      }}
            ...
            >
              <Typography sx={{ mb: 1 }}>
                PayLentine - Your trusted global payment partner
              </Typography>
              <img
                src={logo}
                alt="PayLentine Logo"
            ...
            <NumericKeypadOverlay
              ...
              inputRef={
                (showKeypad === 'bank'
                  ...
                  : showKeypad === 'ewallet'
                  ? ewalletAmountRef
                  : qrAmountRef) as React.RefObject<HTMLInputElement>
              }
            />
          )}
        </Box>
        ...
        >
          ...
          >
            <Box display="flex" alignItems="center" mb={2}>
              <IconButton onClick={resetAll} sx={{ mr: 1, color: brandColor }}>
                <ArrowBackIcon />
              </IconButton>
              <Typography variant="h5" fontWeight={800} color={brandColor}>
                QR Payment
              </Typography>
            </Box>
            <Divider sx={{ mb: 2, width: '100%' }} />
            <Typography sx={{ fontWeight: 600, color: brandColor, mb: 1 }}>
              Amount
            </Typography>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
              <Typography
            ...
            {qrAmount && Number(qrAmount) > 0 && (
              ...
              >
                <Typography sx={{ mb: 1, color: accentColor, fontWeight: 600 }}>
                  Scan this QR to pay
                </Typography>
                <QRCodeCanvas
                  value={`paylentine://topup?amount=${qrAmount}`}
                  size={180}
                />
              </Box>
            )}
        ...
        >
          <Box sx={{ p: 4 }}>
            ...
            {summary && (
              ...
              >
                <Typography sx={{ fontWeight: 700, color: brandColor, mb: 1 }}>
                  Summary
                </Typography>
                <Typography>
                  Method: <b>{summary.method}</b>
                </Typography>
                <Typography>
                  Option: <b>{summary.option}</b>
                </Typography>
                <Typography>
                  Amount: <b>RM{summary.amount}</b>
                </Typography>
              </Box>
            )}
          </Box>
      ...
      >
        ...
        >
          <Box sx={{ p: 4 }}>
            ...
            <Typography variant="h4" fontWeight={900} color={brandColor} mb={2}>
              Top Up Successful!
            </Typography>
            {summary && (
              <Box
            ...
            <Button
              ...
              onClick={() => {
                window.location.href = '/duplicateddashboard';
              }}
            >
              Back to Dashboard
            </Button>
